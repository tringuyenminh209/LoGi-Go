...
const stats = [
  { icon: Truck, label: "総配送", value: "1,247", unit: "件", color: "#2563EB", screen: null },
  { icon: Clock, label: "走行時間", value: "3,420", unit: "h", color: "#06B6D4", screen: null },
  { icon: Leaf, label: "CO₂削減", value: "2.8", unit: "t", color: "#10B981", screen: "carbon" },
  { icon: Award, label: "評価", value: "4.9", unit: "/5", color: "#F59E0B", screen: null },
];
...
const menuSections = [
  {
    ...
    items: [
      ...
      { icon: GraduationCap, label: "資格・免許管理", value: "4件", screen: "certifications" },
    ],
  },
  {
    title: "アカウント",
    items: [
      ...
      { icon: Truck, label: "車両情報", value: "10t冷蔵", screen: null },
    ...
    <div className="min-h-screen pb-24" style={{ background: "#0A1628" }}>
      ...
      >
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h2 className="text-white text-[20px]" style={{ fontFamily: "'Noto Sans JP', sans-serif", fontWeight: 600 }}>田中太郎</h2>
            <p className="text-slate-400 text-[13px]" style={{ fontFamily: "'Noto Sans JP', sans-serif" }}>ドライバー · 大阪営業所</p>
          ...
          {[65, 78, 82, 70, 90, 85, 72, 88, 95, 80, 76, 92, 68, 85, 79, 93, 87, 74, 91, 83, 77, 89, 94, 80, 86, 73, 88, 92, 84, 78].map((v, i) => (
            <div key={i} className="flex-1 flex flex-col-reverse">
              <div
                ...
                style={{
                  height: `${v * 0.4}px`,
                  background: v > 85 ? "#10B981" : v > 70 ? "#06B6D4" : "#2563EB",
                  opacity: 0.7,
                }}
              />
            </div>
                ...
                {item.value && (
                  <span
                    ...
                    style={{
                      ...
                      color: item.screen === "ocr-review" ? "#F59E0B" : "#94A3B8",
                    }}
                  >
                    {item.value}
                  </span>
